...
<div class='para'>
    <p style='color:black;text-align:start;'><strong>{{$user->firstname}} {{$user->lastname}} - KSN: {{$user->ksn}}</strong> checked-in for TravelSafe on {{$travel->created_at}} but has not activated the check-out button yet.</p>
