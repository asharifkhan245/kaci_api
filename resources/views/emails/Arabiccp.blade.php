...
<div class='para'>
 <p style='color:black;text-align:end;'>.({{$user->updated_at}}) Kaci لقد قمت للتو بتغيير كلمة مرورك في حسابك على</p>
<p style='color:black;text-align:end;'>support@kaci.help. إذا لم تقم بهذا الإجراء ، يرجى الاتصال بفريق دعم الحساب لدينا على الفور على</p>
