...
<div class='para'>
  <div class='para'>
    <p style='color:black;text-align:start;'><strong>{{$user->firstname}} {{$user->lastname}} - KSN: {{$user->ksn}}</strong> 在 {{$travel->created_at}} 登记了TravelSafe，但尚未激活签出按钮。请检查您的受托人。</p>

    <p style='color:black;text-align:start;'>请点击以下链接查看详情</p>
    <p style='color:black;text-align:start;'><a href='{{$travel->link}}'>{{$travel->link}}</a></p>

    <strong style='color:black;text-align:start;'>警觉的助手！</strong>
</div>
