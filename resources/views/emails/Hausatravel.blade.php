...
<div class='para'>
  <div class='para'>
    <p style='color:black;text-align:start;'><strong>{{$user->firstname}} {{$user->lastname}} - KSN: {{$user->ksn}}</strong> ya check-in da TravelSafe a ranar {{$travel->created_at}} amma ba ya aika motsin rai ba.</p>

    <p style='color:black;text-align:start;'>Don Allah biya wannan takardar don ganin bayanai</p>
