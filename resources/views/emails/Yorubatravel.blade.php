...
<div class='para'>
  <div class='para'>
    <p style='color:black;text-align:start;'><strong>{{$user->firstname}} {{$user->lastname}} - KSN: {{$user->ksn}}</strong> ti paapọ ni fọwọsiwọna ni {{$travel->created_at}} ṣugbọn ko ri ni wulo ti o dabi odoore.</p>
    ...
    <strong style='color:black;text-align:start;'>Alaisan Onidanran!</strong>
</div>
