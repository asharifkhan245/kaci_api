...
<div class='para'>
   <p style='color:black;text-align:start;'><strong>{{$ambulance->line}}</strong> ya fito a cikin damuwa da yin ku taimakon ku.</p>

<p style='color:black;text-align:start;'>Da fatan ku je nau'in wannan ratsa don kallon bayanai</p>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="20" background="https://kacinew.s3.amazonaws.com/message_images/Group+9752.png" style='background-size:cover;background-repeat:no-repeat;'>
        ...
        <div class="container">
            ...
            <center>
                ...
                <div class="container" style="justify-content:center;padding:20px;width:80%;text-align:start;">
                    <div class="message">

                        <p style='color:black;text-align:start;font-size:15px;'>Dear <strong>{{$user->firstname}},</strong></p>
                    </div>
                    <div class='para'>
                        <p style='color:black;text-align:start;'>Ku cigaba da canja kalmar sirri ku a kan ku kan Kaci ({{$user->updated_at}}).</p>
                        <p style='color:black;text-align:start;'>Idan ba ku yi wannan aikin ba, don Allah ku gani ma'anarmu na taimako ta email a support@kaci.help.</p>

                        <br>
                        <strong style='color:black;text-align:start;'>Mai yin Damuwa Mai Tsari!</strong>
                ...
                <center>
                    <div class="flex" style="display:inline-flex;text-align: center;margin-right:80px;margin-top:-20px;">
                        <ul style="display:inline-flex;">
                            <li style='list-style:none;padding-left:40px'><a href='https://www.facebook.com/kacihelp'>
                                    <div style='background-color:white;border-radius:100px;width: 25px;height: 25px;'><img src='https://kacinew.s3.amazonaws.com/icons8-facebook-f-24.png' height=15px width=15px style='margin-top:5px'></div>
                                </a></li>
                            <li style='list-style:none;padding-left:40px'><a href='https://www.instagram.com/kacihelp'>
                                    <div style='background-color:white;border-radius:100px;width: 25px;height: 25px;'><img src='https://kacinew.s3.amazonaws.com/icons8-instagram-24.png' height=17px width=17px style='margin-top:5px'></div>
                                </a></li>
                            <li style='list-style:none;padding-left:40px'><a href='https://www.twitter.com/kacihelp'>
                                    <div style='background-color:white;border-radius:100px;width: 25px;height: 25px;'>

                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="text-xl" height=15px width=15px style='margin-top:5px' xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <!-- <img src='https://kacinew.s3.amazonaws.com/icons8-twitter-30+(1).png' height=15px width=15px style='margin-top:5px'> -->

                                    </div>
                                </a></li>
                            <li style='list-style:none;padding-left:40px'><a href=' https://www.linkedin.com/company/kacihelp'>
                                    <div style='background-color:white;border-radius:100px;width: 25px;height: 25px;'><img src='https://kacinew.s3.amazonaws.com/icons8-linkedin-2-30.png' height=15px width=15px style='margin-top:5px'></div>
                                </a></li>
                        </ul>
                    </div>
                </center>
