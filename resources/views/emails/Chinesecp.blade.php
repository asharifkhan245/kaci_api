...
<div class='para'>
   <p style='color:black;text-align:start;'>您刚刚在您的Kaci帐户上更改了密码 ({{$user->updated_at}})。</p>
<p style='color:black;text-align:start;'>如果您没有执行此操作，请立即联系我们的帐户支持团队，发送邮件至support@kaci.help。</p>
