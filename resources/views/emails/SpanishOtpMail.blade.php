...
<div class='para'>
   <p style='color:black;text-align:start;'>Acabas de actualizar tu dirección de correo electrónico. Por favor, ingresa este código de verificación para confirmar tu nueva dirección de correo electrónico de cuenta Kaci.</p>
<p style='color:black;text-align:start;font-size:20px;margin-top:5px;' ><strong>{{$token}}</strong></p>
<p style='color:black;text-align:start;font-style: italic;'>Nota: Este código no debe compartirse y caducará después de 15 minutos.</p>
