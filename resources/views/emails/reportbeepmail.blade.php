            ...
            <center>
                <div class="container" style="justify-content:center;padding:20px;text-align:start;">
                    ...
                    <div class="message">
                        ...
                        <p style='color:black;text-align:left;font-size:15px;'>Dear Admin,</p>
                        <p style='color:black;text-align:left;font-size:15px;'>You have a Beep Report.</p>
                    </div>


                    <div class='para p-5'>
                        <p style='color:black;text-align:left;'><strong>DETAILS</strong></p>

                        <p style='color:black;text-align:left;'><strong>User</strong> : {{$notifyUser->firstname ,$notifyUser->ksn }}</p>
                        <p style='color:black;text-align:left;'><strong>Reporter</strong> : {{$user->firstname , $user->ksn }} </p>
                        <p style='color:black;text-align:left;'><strong>Beep Reference Code</strong> : </p>
                        <p style='color:black;text-align:left;'><strong>Beep Date/Time</strong> : </p>
                        <p style='color:black;text-align:left;'><strong>Report Date/Time</strong> : {{$reportItem->created_at}} </p>
                        <p style='color:black;text-align:left;'><strong>Report Type:</strong> {{$reportItem->type}}</p>
                        <p style='color:black;text-align:left;'><strong>Report Reason</strong> {{$reportreason->name}}</p>
                        <p style='color:black;text-align:left;'><strong>Report Message</strong> : {{$reportItem->description}}</p>

                        <p style='color:black;text-align:center;'><strong>The Watchful Assistant!</strong></p>
                    </div>
