...
<div class='para'>
 <p style='color:black;text-align:start;'>{{$ambulance->line}} ({{$user->firstname}} {{$user->lastname}}) se registrÃ³ en TravelSafe el {{$ambulance->created_at}}, pero aÃºn no ha activado el botÃ³n de salida. Por favor, compruebe a su dependiente.</p>

<p style='color:black;text-align:start;'>Por favor, siga este enlace para ver los detalles:</p>
<p style='color:black;text-align:start;'><a href='{{$ambulance->link}}'>{{$ambulance->link}}</a></p>

<strong style='color:black;text-align:start;'>Â¡El Asistente Atento!</strong>
