...
<p style='color:black;text-align:start;'><strong>Reference Code</strong>: {{$feedback->reference_code}}</p>
<p style='color:black;text-align:start;'><strong>Feedback</strong>: {{$feedback->text}}</p>
