...
<br>
 <div class="container">
  ...
  <div stylr='margin-top:40px;'>
   <img src="https://kacinew.s3.amazonaws.com/kaci_logo/Group+-27.png" height=120px width=200px>
</div>
</center>
<br>
...
<div class="message">
     ...
     <p style='color:black;text-align:end;font-size:15px;'> ،<strong>{{$user->firstname}}</strong> عزيزي </p>
</div>
<div class='para'>
  <div class='para'>
    <p style='color:black;text-align:end;'><strong>{{$user->firstname}} {{$user->lastname}} - KSN: {{$user->ksn}}</strong> قام بالتسجيل في TravelSafe في {{$travel->created_at}} ولكنه لم يقم بتنشيط زر الخروج بعد. يرجى التحقق من معاليك.</p>

    <p style='color:black;text-align:end;'>يرجى اتباع هذا الرابط لعرض التفاصيل</p>
    <p style='color:black;text-align:emd;'><a href='{{$travel->link}}'>{{$travel->link}}</a></p>

    <strong style='color:black;text-align:end;'>المساعد اليقظ!</strong>
</div>
