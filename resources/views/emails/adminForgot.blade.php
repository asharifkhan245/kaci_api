...
<br>
<center>
 <div class="container" style="background-color: white;justify-content:center;padding:20px;text-align:start;">
<div class="message">
    
    <p style='color:black;text-align:start;font-size:15px;'>Dear <strong>{{$sub->name}},</strong></p>
</div>
<div class='para'>
    <p style='color:black;text-align:start;'>We received request that you want to change the password on your account. Please enter this verification code to reset your Kaci password.</p>

<p style='color:black;text-align:start;'><strong>{{$token}}</strong></p>
<p style='color:black;text-align:start;font-style:italic;'>Note:This code should not be shared and will expire after 15 minutes.</p>
