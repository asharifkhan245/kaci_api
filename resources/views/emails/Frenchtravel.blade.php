...
<div class="message">
   ...
   <div class='para'>
    <p style='color:black;text-align:start;'><strong>{{$user->firstname}} {{$user->lastname}} - KSN: {{$user->ksn}}</strong> s'est enregistré pour TravelSafe le {{$travel->created_at}}, mais n'a pas encore activé le bouton de départ.</p>

    <p style='color:black;text-align:start;'>Veuillez suivre ce lien pour voir les détails</p>
