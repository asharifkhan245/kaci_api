...
<div class="message">
    ...
    <p style='color:black;text-align:start;font-size:15px;'>Cher <strong>{{$user->firstname}},</strong></p>
</div>
<div class='para'>
  <p style='color:black;text-align:start;'>Vous venez de changer votre mot de passe ({{$user->updated_at}}) sur votre compte Kaci.</p>
<p style='color:black;text-align:start;'>Si vous n'avez pas effectuÃ© cette action, veuillez contacter immÃ©diatement notre Ã©quipe de support de compte Ã  l'adresse support@kaci.help.</p>
