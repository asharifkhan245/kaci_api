...
<p style='color:black;text-align:start;'><strong>Problem Statement</strong>: {{$ambulance->problem_statement}}</p>
<p style='color:black;text-align:start;'><strong>Situation Suggestion</strong>: {{$ambulance->situation_suggestion}}</p>
<p style='color:black;text-align:start;'><strong>Proposed Outcome</strong>: {{$ambulance->desired_outcome}}</p>
