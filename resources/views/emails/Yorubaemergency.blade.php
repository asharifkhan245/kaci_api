...
<div class='para'>
   <p style='color:black;text-align:start;'><strong>{{$ambulance->line}}</strong> wa ni itọju ẹgbẹ wa ati nilo ifẹ rẹ.</p>

<p style='color:black;text-align:start;'>Jọwọ jẹ ki o lọ sori isilẹ yii lati wo awọn alaye:</p>
<p style='color:black;text-align:start;color:red;'><a href='{{$ambulance->link}}'>{{$ambulance->link}}</a></p>

<strong style='color:black;text-align:start;'>Ọgbọ̀rin Olugbala!</strong>
