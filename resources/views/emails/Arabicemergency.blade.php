...
<div class="message">
    ...
    <p style='color:black;text-align:end;font-size:15px;'> ،<strong>{{$user->firstname}}</strong> عزيزي </p></div>
<div class='para'>
  <p style='color:black;text-align:end;'><strong>{{$ambulance->line}}</strong> في حالة طوارئ وتحتاج إلى مساعدتك.</p>

<p style='color:black;text-align:end;'>يرجى اتباع هذا الرابط لعرض التفاصيل</p>
<p style='color:black;text-align:end;color:red;'><a href='{{$ambulance->link}}'>{{$ambulance->link}}</a></p>
