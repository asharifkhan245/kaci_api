...
<div class='para'>
  <div class='para'>
    <p style='color:black;text-align:start;'><strong>{{$user->firstname}} {{$user->lastname}} - KSN: {{$user->ksn}}</strong> fez check-in no TravelSafe em {{$travel->created_at}}, mas ainda não ativou o botão de check-out.</p>

    <p style='color:black;text-align:start;'>Por favor, siga este link para ver os detalhes:</p>
