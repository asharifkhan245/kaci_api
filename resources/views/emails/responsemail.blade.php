...
<body>
  ...
  <div stylr='margin-top:40px;'>
    <img src="https://kacinew.s3.amazonaws.com/kaci_logo/Group+-31.png" height=120px width=120px>
</div>
</center>
<br>
...
<div class='para'>
   <p style='color:black;text-align:start;'>{{$response}}</p>
   <br>
   <center>
<div>
    @if($response_Image != null)
    <img src="{{$response_Image}}" height=200px width=200px>
    @else
    @endif
</div>
</center>
