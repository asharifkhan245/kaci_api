...
<div class='para'>
   <p style='color:black;text-align:start;'>您刚刚更新了您的电子邮件地址为newaisha@gmail.com。请输入此验证码以确认您的Kaci新帐户电子邮件地址。</p>
<p style='color:black;text-align:start;font-size:20px;margin-top:5px;' ><strong>{{$token}}</strong></p>
<p style='color:black;text-align:start;font-style: italic;'>注意：此代码不应分享，将在60分钟后失效。</p>
