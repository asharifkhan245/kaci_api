...
<p style='color:black;text-align:start;'><strong>User</strong><br>Name: {{$user->firstname}} {{$user->lastname}}<br>KSN: {{$user->ksn}}<br>Email: {{$user->email}}<br>Phone: {{$user->phone_number}}</p>
<p style='color:black;text-align:start;'><strong>Reference Code</strong>: {{$ambulance->reference_code}}</p>
<p style='color:black;text-align:start;'><strong>Location</strong>: {{$ambulance->location}}</p>
<p style='color:black;text-align:start;'><strong>Country</strong>: {{$ambulance->country}}</p>
<p style='color:black;text-align:start;'><strong>Address</strong>: {{$ambulance->address}}</p>
<p style='color:black;text-align:start;'><strong>Ambulance Service</strong>: {{$ambulance->ambulance_service}}</p>
<p style='color:black;text-align:start;'><strong>Incidence Nature</strong>: {{$ambulance->incidence_nature}}</p>
<p style='color:black;text-align:start;'><strong>People Involved</strong>: {{$ambulance->people_involved}}</p>
<p style='color:black;text-align:start;'><strong>Previous Hospital Details</strong>: {{$ambulance->previous_hospital}}</p>
<p style='color:black;text-align:start;'><strong>Medication</strong>: {{$ambulance->medication}}</p>
@if($ambulance->medication === 'YES' || $ambulance->medication === 'Yes')
<p style='color:black;text-align:start;'><strong>User Medication</strong></p>
@foreach($medication as $a)
<p>Name: {{$a->name}}<br>Description: {{$a->description}}<br>Dosage: {{$a->dosage}}</p>
@endforeach
@endif
<p style='color:black;text-align:start;'><strong>Map</strong>: {{$map}}</p>
