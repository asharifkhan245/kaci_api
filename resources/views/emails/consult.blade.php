...
<p style='color:black;text-align:start;'><strong>Date/Time</strong>: {{$ambulance->created_at}}</p>
...
<p style='color:black;text-align:start;'><strong>Preferred Agency</strong>: {{$ambulance->target_agency}}</p>
<p style='color:black;text-align:start;'><strong>Consult Subject</strong>: {{$ambulance->subject}}</p>
<p style='color:black;text-align:start;'><strong>Consult Details </strong>: {{$ambulance->description}}</p>
<p style='color:black;text-align:start;'><strong>Anonymous</strong>: {{$ambulance->anonymous}}</p>
                ...
                @elseif($imageArray->type === 'audio')
                  ...
                  <div style="background-color:#f53939;padding:auto;width:90px;height:90px;">
                    ...
                    <a href="{{ $imageArray->url }}" target="_blank" >
                      ...
                      @elseif($imageArray->type === 'unknown')
                 <div style="background-color:#f53939;padding:auto;width:90px;height:90px;">
                    <a href="{{ $imageArray->url }}" target="_blank" >
