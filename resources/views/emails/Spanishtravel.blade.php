...
<div class='para'>
   <div class='para'>
    <p style='color:black;text-align:start;'><strong>{{$user->firstname}} {{$user->lastname}} - KSN: {{$user->ksn}}</strong> se ha registrado en TravelSafe en {{$travel->created_at}}, pero aÃºn no ha activado el botÃ³n de check-out.</p>

    <p style='color:black;text-align:start;'>Por favor, siga este enlace para ver los detalles:</p>
    <p style='color:black;text-align:start;'><a href='{{$travel->link}}'>{{$travel->link}}</a></p>
