...
<body>
  <table width="100%" border="0" cellspacing="0" style='background-color: white;'>
      <tr>
          <td width='40%'>  <div style='list-style:none;text-align:start;'><img src="https://kacinew.s3.amazonaws.com/kaci_logo/Logo.png" height=30px width=90px></div> </td>
         
          <td width='60%'><div style='list-style:none;font-size:25px;color:black;'><strong style='text-align:center;'>Travel</strong></div></td>
        ...
        <div width="100%" border="0" cellspacing="0" style='background-color: #3f0d12;background-image: linear-gradient(315deg, #e41c38 0%, #E81828 74%);'>
           ...
           <table>
            <tr style='text-align:center;'>
                <td><h2 style='text-align:center;font-size:25px;font-weight:bolder;color:white;margin-top:20px '>Check on your Dependent!<i class='fas fa-play' style='font-size:24px'></i></h2></td>
            </tr>
           </table>
           </center>
           <center>
              ...
              <table width="80%" style='background-color: white;'>
                  ...
                  @endforeach
                    <tr>
                     ...
                     <tr>
                      <td>
                          <center>
                          <div style='text-align:center;background-color: red;padding:5px;margin-top:20px;width:130px;border-radius:20px'>
                          <div style='margin-botton:0;color:white;'>Travel Details</div>
                          </div>
                          </center>
                      </td>
                  </tr>
                   <tr>
                      <td style='text-align:center;'>
                          <center>
                        <h5 style='font-weight:light;margin-top:10px;margin-bottom:0;color:gray;'>Place of Boarding</h5>
                           <div style='font-weight:bolder;color:black;'>{{$ambulance->boarding}}</div>
                          </center>
                   ...
                   <tr>
                      <td style='text-align:center;'>
                          <center>
                        <h5 style='font-weight:light;margin-top:10px;margin-bottom:0;color:gray;'>Place of Destination</h5>
                           <div style='font-weight:bolder;color:black;'>{{$ambulance->destination}}</div>
                          </center>
                  ...
                  <tr>
                      <td style='text-align:center;'>
                          <center>
                        <h5 style='font-weight:light;margin-top:10px;margin-bottom:0;color:gray;'>Trip Duration</h5>
                           <div style='font-weight:bolder;color:black;'>{{$ambulance->trip_duration}}</div>
                          </center>
                    ...
                    <tr>
                      <td style='text-align:center;'>
                          <center>
                        <h5 style='font-weight:light;margin-top:10px;margin-bottom:0;color:gray;'>Vehicle Type</h5>
                           <div style='font-weight:bolder;color:black;'>{{$ambulance->vehicle_type}}</div>
                          </center>
                  ...
                  <tr>
                      <td style='text-align:center;'>
                          <center>
                        <h5 style='font-weight:light;margin-top:10px;margin-bottom:0;color:gray;'>Vehicle Details</h5>
                           <div style='font-weight:bolder;color:black;'>{{$ambulance->vehicle_detail}}</div>
                          </center>
