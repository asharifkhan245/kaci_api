...
<div class="message">
  ...
  <div class='para'>
    <p style='color:black;text-align:start;'><strong>{{$user->firstname}} {{$user->lastname}} - KSN: {{$user->ksn}}</strong> ga-egbuwara na TravelSafe na aha afo na-enye na aha {{$travel->created_at}} mana anyịhụrụ ọ bụla na ụlọ gbasọrọ gbasọ.</p>

    <p style='color:black;text-align:start;'>Biko kpọtụrụ nkọwapụ na-esonụ aha</p>
