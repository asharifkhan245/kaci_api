...
<div class="message">
    ...
    <p style='color:black;text-align:start;font-size:15px;'>亲爱的 <strong>{{$user->firstname}},</strong></p>
</div>
<div class='para'>
  <p style='color:black;text-align:start;'>感谢您提交反馈和错误报告，我们已经收到并将确实处理。</p>

<p style='color:black;text-align:start;'>当问题解决后，我们将无法回复，但如果有具体的指示，我们将联系您。</p>
<p style='color:black;text-align:start;'>感谢您成为我们社区的一部分。</p>

<strong style='color:black;text-align:start;'>警惕的助手！</strong>
