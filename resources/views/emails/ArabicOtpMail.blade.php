...
<div class='para'>
   <p style='color:black;text-align:start;'>لقد قمت للتو بتحديث عنوان بريدك الإلكتروني إلى. الرجاء إدخال رمز التحقق هذا لتأكيد عنوان بريدك الإلكتروني الجديد لحسابك Kaci.</p>
<p style='color:black;text-align:start;font-size:20px;margin-top:5px;' ><strong>{{$token}}</strong></p>
<p style='color:black;text-align:start;font-style: italic;'>ملاحظة: هذا الرمز لا يجب مشاركته وسينتهي صلاحيته بعد 15 دقيقة.</p>
