...
<div class='para'>
   <p style='color:black;text-align:start;'>Ngenndi o fayii ndeeɗo email. Ndekenno mi ko wanoo ko nga ni ndey garaa mo ndeeɗo email e Kaci.</p>
<p style='color:black;text-align:start;font-size:20px;margin-top:5px;' ><strong>{{$token}}</strong></p>
<p style='color:black;text-align:start;font-style: italic;'>Olu: Gano haɗi lo mbaawii, walla sappi 15 nduwan.</p>
