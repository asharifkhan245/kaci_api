...
<div class='para'>
   <p styl<p style='color:black;text-align:start;'>Você acabou de alterar sua senha ({{$user->updated_at}}) em sua conta Kaci.</p>
<p style='color:black;text-align:start;'>Se você não realizou esta ação, por favor, entre em contato imediatamente com nossa Equipe de Suporte de Conta em support@kaci.help.</p>
