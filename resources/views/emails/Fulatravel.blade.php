...
<div class='para'>
  <div class='para'>
    <p style='color:black;text-align:start;'><strong>{{$user->firstname}} {{$user->lastname}} - KSN: {{$user->ksn}}</strong> yi tashi domin TravelSafe a ranar {{$travel->created_at}} amma ba ta san cikin kasuwa ba.</p>

    <p style='color:black;text-align:start;'>Don Allah biya wannan tasharwa don samu bayanan</p>
